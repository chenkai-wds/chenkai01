...
void modifyNode()
{
    ...
    printf("Select to change name enter 1, then enter the name of the object to be modified.\n");
    printf("Select to change number enter 2, then enter the number of the object to be modified.\n");
    scanf("%d",&a);
    if(a==1){
        scanf("%s",name1);
        node *pMove;
